...
#[derive(Debug, Default)]
pub struct Message {
    main_battery_voltage: Option<isize>,
    channel2_battery_voltage: Option<isize>,
    channel3_battery_voltage: Option<isize>,
    auxiliary_starter_voltage: Option<isize>,
    battery_bank_midpoint_voltage: Option<isize>,
    battery_bank_midpoint_deviation: Option<isize>,
    panel_voltage: Option<isize>,
    panel_power: Option<isize>,
    main_battery_current: Option<isize>,
    channel2_battery_current: Option<isize>,
    channel3_battery_current: Option<isize>,
    load_current: Option<isize>,
    load_output_state: Option<String>,
    battery_temperature: Option<isize>,
    instantaneous_power: Option<isize>,
    consumed_amp_hours: Option<isize>,
    state_of_charge: Option<isize>,
    time_to_go: Option<isize>,
    alarm_active: Option<String>,
    ...
    day_sequence_number: Option<isize>,
    device_mode: Option<isize>,
    ac_output_voltage: Option<isize>,
    ac_output_current: Option<isize>,
    ac_output_apparent_power: Option<isize>,
    warning_reason: Option<isize>,
    tracker_mode_operation: Option<isize>,
    dc_monitor_mode: Option<isize>,
}
